<?php
// file: list_students.php
// 1. ส่วน Logic: ประมวลผลก่อนแสดงผล HTML
include_once 'db.php';
    ...
    if ($_FILES['file']['name']) {
        ...
        if (end($filename) == 'csv') {
            ...
            while ($data = fgetcsv($handle, 1000, ",")) {
                // ข้ามบรรทัดหัวตาราง ถ้าช่องแรกไม่ใช่ตัวเลข
...
if (isset($_GET['delete_id'])) {
    ...
    // ใช้ header ไม่ได้เพราะอาจจะ output HTML ไปแล้วในบางเคส แต่เพื่อความชัวร์ใช้ JS Redirect
...
<style>
    ...
    /* Table Styles */
    .card-table { background: white; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.04); border: none; overflow: hidden; display: flex; flex-direction: column; flex-grow: 1; min-height: 500px; }
